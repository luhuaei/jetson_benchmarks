...
class run_benchmark_models():
    ...
    def execute(self, read_index):
        ...
        self.model_name, _framework, num_devices, ws_gpu, ws_dla, model_input, model_output, self.batch_size_gpu, self.batch_size_dla, self.shapes = self.benchmark_data.benchmark_csv(read_index)
        ...
        self.trt_engine = load_store_engine(model_path=self.model_path, model_name=model_ext, num_devices=num_devices,
                                            ...
                                            model_input=model_input, model_output=model_output, shapes=self.shapes)
